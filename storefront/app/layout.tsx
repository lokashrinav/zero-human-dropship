		...
		<StoreConfigProvider value={storeConfig}>
			<CartProvider>
				<div className="flex min-h-screen flex-col overflow-x-clip">
					<div className="border-b border-lime-300/15 bg-lime-300 px-4 py-2 text-center text-[0.64rem] font-semibold uppercase tracking-[0.1em] text-neutral-950 sm:text-xs">
						Honest shipping details · Secure Stripe checkout
					</div>
						...
						<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
							<div className="relative flex h-16 items-center justify-between">
								<div className="flex items-center gap-2">
									<Link href="/" className="group flex items-center gap-2.5" aria-label="KOVA home">
										<span className="grid size-7 place-items-center rounded-lg bg-lime-300 text-[0.65rem] font-black tracking-[-0.08em] text-neutral-950 transition-transform group-hover:-rotate-6">
											K/
										</span>
